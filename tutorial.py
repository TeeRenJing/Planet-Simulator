...
class Planet:
    # Distance from earth to the sun in metres
    AU = 149.6e6 * 1000
    G = 6.67428e-11
    # what 1 metre means in pixels
    SCALE = 250/ AU # 1AU = 250 pixels
    TIMESTEP = 3600*24 # 3600secs in an hour, 24hr in a day, 1 day at a time update
